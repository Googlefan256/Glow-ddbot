...
setInterval(function() {
       ...
       client.channels.fetch('856183879828242462').then(b=>b.send('<@661028503927521295>β版bot落ちてますよ'))
		  }
		})
		client.users.fetch('832614051514417202').then(a =>{
			if(a.presence.status === "offline"){
       client.channels.fetch('856183879828242462').then(b=>b.send('<@661028503927521295>bot落ちてますよ'))
		  }
		})
 	}, 60000);
